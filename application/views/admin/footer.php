    ...
    $('#tblAdminMsrfConcern').DataTable({
        "serverSide": true,
        "processing": true,
        "ajax": {
            "url": "<?= base_url(); ?>DataTables/create_msrf_ticket_admin",
            "type": "POST"
        },
        "responsive": true,
        "autoWidth": false,
    ...
    $('#tblTraccRequestAdmin').DataTable({
        "serverSide": true,
        "processing": true,
        "ajax": {
            "url": "<?= base_url(); ?>DataTables/create_tracc_request_ticket_admin",
            "type": "POST"
        },
        "responsive": true,
        "autoWidth": false,
