...
class UsersTraccReq_model extends CI_Model {
	...
	public function update_cr($recid, $crf_comp_checkbox_values = null, $checkbox_cus_req_form_del, $id) {
		$trf_number = $this->input->post('trf_number', true);
	...
	public function update_ir($recid, $irf_comp_checkbox_value = null, $checkbox_item_req_form, $id) {
	...
	public function update_batch_rows_gl_setup($ticket_id, $update_data_gl_setup, $insert_data_gl_setup) {
		if(!empty($insert_data_gl_setup)) {
	...
	public function update_batch_rows_whs_setup($ticket_id, $update_data_whs_setup, $insert_data_whs_setup) {
