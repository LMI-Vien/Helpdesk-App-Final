                                        ...
                                        <form id="TRC_form" action="<?= site_url('UsersTraccCon_controller/user_creation_tickets_tracc_concern'); ?>" method="POST" enctype="multipart/form-data">
                                            <div class="col-md-12">
			                    				<div class="form-group">
                                                    ...
                                                    <input type="text" name="control_number" id="control_number" class="form-control" value="<?= $trc; ?>" required pattern=".*-.*" title="Control number must contain a hyphen (-)" oninput="this.value = this.value.toUpperCase().trim().replace(/\s+/g, '');" readonly>
			                    				</div>                                               
			                    			</div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label>Details Concern</label>
                                                        <textarea class="form-control" name="details_concern" id="details_concern" placeholder="Place the details concern here" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px; resize: vertical;" required></textarea>
                                                </div>
                                            </div>
