                ...
                <div class="box">
                    <div class="box-body">
                        <div class="table-responsive">
                            <table id="rejected_req" class="table table-striped">
                                <thead>
                                    <tr>
                                        <th>Ticket ID</th>
                                        <th>Requested By</th>
...
$(document).ready(function() {
    let table = $('#rejected_req').DataTable({
        "info": false,
        "serverSide": true,
        "processing": true,
        "searching": true,
        "ajax": {
            "url": "<?= base_url(); ?>DataTables/get_rejected_tracc_request",
            "type": "POST",
        },
        "columns": [
            { "data": "ticket_id" },
