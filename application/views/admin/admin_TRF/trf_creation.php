                    ...
                    <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="msrf">
                                <section id="new">
                                    <div class="row">
                                        <form id="TRF_form" action="<?= site_url('AdminTraccReq_controller/admin_creation_tickets_tracc_request'); ?>" method="POST" enctype="multipart/form-data">
                                            <div class="col-md-12">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="file" name="uploaded_files" id="uploaded_files" class="form-control">
                                                </div>
                                            </div>
