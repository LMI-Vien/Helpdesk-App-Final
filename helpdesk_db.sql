...
CREATE TABLE `departments` (
  ...
  `manager_id` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `service_request_msrf` (
  ...
  `requestor_name` varchar(155) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `specify` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL,
  `details_concern` text COLLATE utf8mb4_unicode_ci,
  `file` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` enum('Open','In Progress','Resolved','Closed','Rejected','Returned','Approved') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `approval_status` enum('Approved','Pending','Rejected','Returned') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `priority` enum('Low','Medium','High') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `requester_id` int(11) DEFAULT NULL,
  `sup_id` int(11) NOT NULL,
  `it_dept_id` int(11) DEFAULT NULL,
  `it_sup_id` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `it_approval_status` enum('Approved','Pending','Rejected','Resolved') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `assigned_it_staff` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `remarks_ict` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `users` (
  ...
  `mname` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `s_api_password` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `department_description` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL,
  `dept_id` int(11) NOT NULL,
  `sup_id` varchar(11) COLLATE utf8mb4_unicode_ci NOT NULL,
  `role` enum('L1','L2','L3','L4') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
